...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            ...
            if(!isset($idd)){
                $query=mysqli_query($con, "select * from post where post_id=1;");
            }
           else{ $query=mysqli_query($con,"select * from post where post_id='$idd' order by post_id desc limit 5 ;");}
            ...
            ?>
                ...
                <div class="row post-top-meta">
                    ...
                    <div class="col-md-10">
                        <a class="link-dark" href="author.php"><?php echo $roww['author'];?></a><a href="#" class="btn follow">Follow</a>
                ...
                <h1 class="posttitle"><?php echo $roww['title'];?></h1>

            </div>

            <!-- Begin Featured Image -->
            <img class="featured-image img-fluid" src="<?php echo $roww['img'];?>" alt="">
            <!-- End Featured Image -->
...
<div class="container">
    <div class="card">
        ...
        $sql="select * from coment where post_id='$idd'";
        $query=mysqli_query($con,$sql);
        if(!$query){
        die('xatolik'.mysqli_connect_error($sql));
        }
while($coment=mysqli_fetch_assoc($query) )  {

?>
        <h3 class=" text text-success fa fa-user"><?php echo $coment['name'];?> <span class="fa fa-message text text-center text-danger"><?php echo $coment['coment'];?></span></h3>
        <?php
}
?>
    </div>
...
<div class="modal" id="myModal">
  ...
  <form action="#" method="post">
    ...
    <div class="mb-3 mt-3">
        <input class="btn btn-outline-info" type="submit" value="send" name="button">
...
<div class="graybg">
    <div class="container">
        <div class="row listrecent listrelated">
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="post.php?id=<?php echo $roww['post_id'];?>">
                        <img class="img-fluid img-thumb" src="<?php echo $roww['img'];?>" alt="">
                    </a>
                    <div class="card-block">
                        <h2 class="card-title"><a href="post.php?id=<?php echo $roww['post_id'];?>"><?php echo $roww['title'];?></a></h2>
                        <div class="metafooter">
                            <div class="wrapfooter">
								...
								<span class="post-name"><a href="author.php"><?php echo $roww['author'];?></a></span><br/>
								<span class="post-date">22 september 2017</span><span class="dot"></span><span class="post-read">10 min read</span>
								</span>
                                <span class="post-read-more"><a href="post.php?id=<?php echo $roww['post_id'];?>" title="<?php echo $roww['title'];?>"><svg class="svgIcon-use" width="25" height="25" viewbox="0 0 25 25"><path d="M19 6c0-1.1-.9-2-2-2H8c-1.1 0-2 .9-2 2v14.66h.012c.01.103.045.204.12.285a.5.5 0 0 0 .706.03L12.5 16.85l5.662 4.126a.508.508 0 0 0 .708-.03.5.5 0 0 0 .118-.285H19V6zm-6.838 9.97L7 19.636V6c0-.55.45-1 1-1h9c.55 0 1 .45 1 1v13.637l-5.162-3.668a.49.49 0 0 0-.676 0z" fill-rule="evenodd"></path></svg></a></span>
                            </div>
                        </div>
                    </div>
                </div>
...
if($_POST['button']){
    $name=$_POST['name'];
    $coment=$_POST['text'];
    $query=mysqli_query($con,"insert into coment(name,coment,post_id) values('$name','$coment','$idd');");
    if(!$query){
        die('xato');
    }
}
